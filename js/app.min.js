...
}}).on("mouseleave.fndtn.tooltip touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip","["+this.attr_name()+"].open",function(e){return/mouse/i.test(e.type)&&s.ie_touch(e)?!1:void(("touch"!=t(this).data("tooltip-open-event-type")||"mouseleave"!=e.type)&&("mouse"==t(this).data("tooltip-open-event-type")&&/MSPointerDown|touchstart/i.test(e.type)?s.convert_to_touch(t(this)):i(this,t(this))))}).on("DOMNodeRemoved DOMAttrModified","["+this.attr_name()+"]:not(a)",function(t){i(this,a(this))})},ie_touch:function(t){return!1},showTip:function(t){var e=this.getTip(t);return this.should_show(t,e)?this.show(t):void 0},getTip:function(e){var n=this.selector(e),i=t.extend({},this.settings,this.data_options(e)),s=null;return n&&(s=this.S('span[data-selector="'+n+'"]'+i.tooltip_class)),"object"==typeof s?s:!1},selector:function(t){var e=t.attr(this.attr_name())||t.attr("data-selector");return"string"!=typeof e&&(e=this.random_str(6),t.attr("data-selector",e).attr("aria-describedby",e)),e},create:function(n){var i=this,s=t.extend({},this.settings,this.data_options(n)),a=this.settings.tip_template;"string"==typeof s.tip_template&&e.hasOwnProperty(s.tip_template)&&(a=e[s.tip_template]);var o=t(a(this.selector(n),t("<div></div>").html(n.attr("title")).html())),r=this.inheritable_classes(n);o.addClass(r).appendTo(s.append_to),Modernizr.touch&&(o.append('<span class="tap-to-close">'+s.touch_close_text+"</span>"),o.on("touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip",function(t){i.hide(n)})),n.removeAttr("title").attr("title","")},reposition:function(e,n,i){var s,a,o,r,l;if(n.css("visibility","hidden").show(),s=e.data("width"),a=n.children(".nub"),o=a.outerHeight(),r=a.outerHeight(),this.small()?n.css({width:"100%"}):n.css({width:s?s:"auto"}),l=function(t,e,n,i,s,a){return t.css({top:e?e:"auto",bottom:i?i:"auto",left:s?s:"auto",right:n?n:"auto"}).end()},l(n,e.offset().top+e.outerHeight()+10,"auto","auto",e.offset().left),this.small())l(n,e.offset().top+e.outerHeight()+10,"auto","auto",12.5,t(this.scope).width()),n.addClass("tip-override"),l(a,-o,"auto","auto",e.offset().left);else{var c=e.offset().left;Foundation.rtl&&(a.addClass("rtl"),c=e.offset().left+e.outerWidth()-n.outerWidth()),l(n,e.offset().top+e.outerHeight()+10,"auto","auto",c),a.attr("style")&&a.removeAttr("style"),n.removeClass("tip-override"),i&&i.indexOf("tip-top")>-1?(Foundation.rtl&&a.addClass("rtl"),l(n,e.offset().top-n.outerHeight(),"auto","auto",c).removeClass("tip-override")):i&&i.indexOf("tip-left")>-1?(l(n,e.offset().top+e.outerHeight()/2-n.outerHeight()/2,"auto","auto",e.offset().left-n.outerWidth()-o).removeClass("tip-override"),a.removeClass("rtl")):i&&i.indexOf("tip-right")>-1&&(l(n,e.offset().top+e.outerHeight()/2-n.outerHeight()/2,"auto","auto",e.offset().left+e.outerWidth()+o).removeClass("tip-override"),a.removeClass("rtl"))}n.css("visibility","visible").hide()},small:function(){return matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches},inheritable_classes:function(e){var n=t.extend({},this.settings,this.data_options(e)),i=["tip-top","tip-left","tip-bottom","tip-right","radius","round"].concat(n.additional_inheritable_classes),s=e.attr("class"),a=s?t.map(s.split(" "),function(e,n){return-1!==t.inArray(e,i)?e:void 0}).join(" "):"";return t.trim(a)},convert_to_touch:function(e){var n=this,i=n.getTip(e),s=t.extend({},n.settings,n.data_options(e));0===i.find(".tap-to-close").length&&(i.append('<span class="tap-to-close">'+s.touch_close_text+"</span>"),i.on("click.fndtn.tooltip.tapclose touchstart.fndtn.tooltip.tapclose MSPointerDown.fndtn.tooltip.tapclose",function(t){n.hide(e)})),e.data("tooltip-open-event-type","touch")},show:function(t){var e=this.getTip(t);"touch"==t.data("tooltip-open-event-type")&&this.convert_to_touch(t),this.reposition(t,e,t.attr("class")),t.addClass("open"),e.fadeIn(150)},hide:function(t){var e=this.getTip(t);e.fadeOut(150,function(){e.find(".tap-to-close").remove(),e.off("click.fndtn.tooltip.tapclose MSPointerDown.fndtn.tapclose"),t.removeClass("open")})},off:function(){var e=this;this.S(this.scope).off(".fndtn.tooltip"),this.S(this.settings.tooltip_class).each(function(n){t("["+e.attr_name()+"]").eq(n).attr("title",t(this).text())}).remove()},reflow:function(){}}}(jQuery,window,window.document),$(document).foundation();var resultados2015={total:9439711,abstencao:4059465,votantes:5380246,brancos:112658,nulos:86467,partidos:{PaF:1981408,PS:1742002,BE:549838,CDU:444905,Outros:462968}},resultados2011={total:9624354,abstencao:4039300,votantes:5585054,brancos:148618,nulos:79399,partidos:{"PPD/PSD":2159181,PS:1566347,"CDS-PP":653888,CDU:441147,BE:288923,Outros:247126}},resultados2009={total:9519921,abstencao:3838663,votantes:5681258,brancos:99086,nulos:76894,partidos:{PS:2077238,PSD:1653665,"CDS-PP":592778,BE:557306,CDU:446279,Outros:178012}},resultados2005={total:8944508,abstencao:3196674,votantes:5747834,brancos:103537,nulos:65515,partidos:{PS:2588312,"PPD/PSD":1653425,CDU:433369,"CDS-PP":416415,BE:364971,Outros:122127}},resultados2002={total:8902713,abstencao:3429058,votantes:5473655,brancos:55121,nulos:52653,partidos:{"PPD/PSD":2200765,PS:2068584,"CDS-PP":477350,CDU:379870,BE:149966,Outros:88542}},resultados1999={total:8864604,abstencao:3449502,votantes:5415102,brancos:56964,nulos:51230,partidos:{PS:2385922,"PPD/PSD":1750158,CDU:487058,"CDS-PP":451643,BE:132333,Outros:99842}},resultados1995={total:8906608,abstencao:3001754,votantes:5904854,brancos:45793,nulos:67300,partidos:{PS:2583755,"PPD/PSD":2014589,"CDS-PP":534470,CDU:506157,"PCTP/MRPP":41137,Outros:111653}},resultados1991={total:8462357,abstencao:2726926,votantes:5735431,brancos:47652,nulos:63020,partidos:{"PPD/PSD":2902351,PS:1670758,CDU:504583,CDS:254317,PSN:96096,Outros:196654}},resultados1987={total:7930668,abstencao:2254310,votantes:5676358,brancos:50135,nulos:73533,partidos:{"PPD/PSD":2850784,PS:1262506,CDU:689137,PRD:278561,CDS:251987,Outros:219715}},resultados1985={total:7818981,abstencao:2020052,votantes:5798929,brancos:48709,nulos:96610,partidos:{"PPD/PSD":1732288,PS:1204321,PRD:1038893,APU:898281,CDS:577580,Outros:202247}},resultados1983={total:7337064,abstencao:1629369,votantes:5707695,brancos:42494,nulos:104276,partidos:{PS:2061309,"PPD/PSD":1554804,APU:1031609,CDS:716705,PDC:39180,Outros:157232}},resultados1980={total:7179023,abstencao:1152628,votantes:6026395,brancos:34522,nulos:103140,partidos:{AD:2706667,FRS:1606198,APU:1009505,"PPD/PSD":147644,UDP:83204,Outros:335515}},resultados1979={total:7249346,abstencao:1241893,votantes:6007453,brancos:42863,nulos:120851,partidos:{AD:2554458,PS:1642136,APU:1129322,PSD:141227,UDP:130842,Outros:245754}},resultados1976={total:6564667,abstencao:1081206,votantes:5483461,brancos:0,nulos:257696,partidos:{PS:1912921,PPD:1335381,CDS:876007,PCP:788830,UDP:91690,Outros:220936}},resultados1975={total:6231372,abstencao:519543,votantes:5711829,brancos:0,nulos:396765,partidos:{PS:2162972,PPD:1507282,PCP:711935,CDS:434879,MDP:236318,Outros:261768}},resultados={2015:resultados2015,2011:resultados2011,2009:resultados2009,2005:resultados2005,2002:resultados2002,1999:resultados1999,1995:resultados1995,1991:resultados1991,1987:resultados1987,1985:resultados1985,1983:resultados1983,1980:resultados1980,1979:resultados1979,1976:resultados1976,1975:resultados1975},addResultados=function(t){var e=resultados[t];for(var n in e.partidos){var i=e.partidos[n],s=i/e.votantes*100,a=n.replace("/","").replace("-","");$("#antes"+t+"Graph").append("<span id='antes-"+t+a+"' data-tooltip aria-haspopup='true' title='"+n+": "+s.toFixed(2)+"%' class='has-tip partido "+a+"' style='width:"+s+"%;'></span>"),$("#antes"+t+"Info").append("<div class='label "+a+"'>"+n+": "+s.toFixed(2)+"%</div>")}s=e.brancos/e.votantes*100,$("#antes"+t+"Graph").append("<span id='antes-"+t+"brancos' data-tooltip aria-haspopup='true' title='Brancos: "+s.toFixed(2)+"%' class='has-tip partido brancos' style='width:"+s+"%;'></span>"),$("#antes"+t+"Info").append("<div class='label brancos'>Brancos: "+s.toFixed(2)+"%</div>"),s=e.nulos/e.votantes*100,$("#antes"+t+"Graph").append("<span id='antes-"+t+"nulos' data-tooltip aria-haspopup='true' title='Nulos: "+s.toFixed(2)+"%' class='has-tip partido nulos' style='width:"+s+"%;'></span>"),$("#antes"+t+"Info").append("<div class='label nulos'>Nulos: "+s.toFixed(2)+"%</div>");for(var n in e.partidos){var i=e.partidos[n],s=i/e.total*100,a=n.replace("/","").replace("-","");$("#depois"+t+"Graph").append("<span id='depois-"+t+a+"' data-tooltip aria-haspopup='true' title='"+n+": "+s.toFixed(2)+"%' class='has-tip depois-"+t+a+" partido "+a+"' style='width:"+s+"%;'></span>"),$("#depois"+t+"Info").append("<div class='label "+a+"'>"+n+": "+s.toFixed(2)+"%???</div>")}s=e.brancos/e.total*100,$("#depois"+t+"Graph").append("<span id='depois-"+t+"brancos' data-tooltip aria-haspopup='true' title='Brancos: "+s.toFixed(2)+"%' class='has-tip partido brancos' style='width:"+s+"%;'></span>"),$("#depois"+t+"Info").append("<div class='label brancos'>Brancos: "+s.toFixed(2)+"%</div>"),s=e.nulos/e.total*100,$("#depois"+t+"Graph").append("<span id='depois-"+t+"nulos' data-tooltip aria-haspopup='true' title='Nulos: "+s.toFixed(2)+"%' class='has-tip partido nulos' style='width:"+s+"%;'></span>"),$("#depois"+t+"Info").append("<div class='label nulos'>Nulos: "+s.toFixed(2)+"%</div>"),s=e.abstencao/e.total*100,$("#depois"+t+"Graph").append("<span id='depois-"+t+"abstencao' data-tooltip aria-haspopup='true' title='Abstenção: "+s.toFixed(2)+"%' class='has-tip partido abstencao' style='width:"+s+"%;'></span>"),$("#depois"+t+"Info").append("<div class='label abstencao'>Abstenção: "+s.toFixed(2)+"%</div>")},anos=[];for(ano in resultados)resultados.hasOwnProperty(ano)&&anos.push(ano);for(anos.sort().reverse(),i=0;i<anos.length;i++)$("#container").append('    <div class="row">          <div class="small-5 columns text-right right-border anoGraph" id="antes'+anos[i]+'Graph"></div>          <div class="small-1 columns text-center label round anoLabel"><span>'+anos[i]+'</span></div>          <div class="small-5 columns text-left left-border anoGraph" id="depois'+anos[i]+'Graph"></div>    </div>'),addResultados(anos[i]);$(".anoGraph").foundation({tooltip:{selector:".has-tip",additional_inheritable_classes:[],tooltip_class:".tooltip",touch_close_text:"tap to close",disable_for_touch:!1,tip_template:function(t,e){return'<span data-selector="'+t+'" class="'+Foundation.libs.tooltip.settings.tooltip_class.substring(1)+'">'+e+'<span class="nub"></span></span>'}}});var antes=0,depois=0;$("[id^='antes-']").hover(function(t){if(1==depois)depois=0;else{var e="#"+t.target.id.replace("antes","depois");antes=1,$(e).toggleClass("highlight").trigger(t.type)}}),$("[id^='depois-']").hover(function(t){if(1==antes)antes=0;else{var e="#"+t.target.id.replace("depois","antes");depois=1,$(e).toggleClass("highlight").trigger(t.type)}}),$("[id^='antes-']").mouseleave(function(t){antes=0,depois=0}),$("[id^='depois-']").mouseleave(function(t){antes=0,depois=0});